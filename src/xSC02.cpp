...
void xSC02::setDateTime(uint16_t year, uint8_t month, uint8_t day, uint8_t hour, uint8_t minute, uint8_t second)
{
...
void xSC02::setDateTime(uint32_t t)
{
    t -= 946681200;
...
void xSC02::setDateTime(const char* date, const char* time)
{
    uint16_t year;
    uint8_t month;
    uint8_t day;
...
char* xSC02::dateFormat(const char* dateFormat, RTCDateTime dt)
{
    char buffer[255];
...
char* xSC02::dateFormat(const char* dateFormat, RTCAlarmTime dt)
{
    char buffer[255];
...
RTCDateTime xSC02::getDateTime(void)
{
    int values[7];
...
uint8_t xSC02::isReady(void) 
{
    return true;
}

void xSC02::enableOutput(bool enabled)
{
    uint8_t value;
...
void xSC02::setBattery(bool timeBattery, bool squareBattery)
{
    uint8_t value;
...
void xSC02::setOutput(DS3231_sqw_t mode)
{
    uint8_t value;
...
DS3231_sqw_t xSC02::getOutput(void)
{
    uint8_t value;
...
void xSC02::enable32kHz(bool enabled)
{
    uint8_t value;
...
void xSC02::forceConversion(void)
{
    uint8_t value;
...
float xSC02::readTemperature(void)
{
    uint8_t msb, lsb;
...
RTCAlarmTime xSC02::getAlarm1(void)
{
    uint8_t values[4];
    RTCAlarmTime a;
...
DS3231_alarm1_t xSC02::getAlarmType1(void)
{
    uint8_t values[4];
    uint8_t mode = 0;
...
void xSC02::setAlarm1(uint8_t dydw, uint8_t hour, uint8_t minute, uint8_t second, DS3231_alarm1_t mode, bool armed)
{
...
bool xSC02::isAlarm1(bool clear)
{
    uint8_t alarm;
...
void xSC02::armAlarm1(bool armed)
{
    uint8_t value;
    value = readRegister8(DS3231_REG_CONTROL);
...
RTCAlarmTime xSC02::getAlarm2(void)
{
    uint8_t values[3];
    RTCAlarmTime a;
...
DS3231_alarm2_t xSC02::getAlarmType2(void)
{
    uint8_t values[3];
    uint8_t mode = 0;
...
void xSC02::setAlarm2(uint8_t dydw, uint8_t hour, uint8_t minute, DS3231_alarm2_t mode, bool armed)
{
    minute = dec2bcd(minute);
    hour = dec2bcd(hour);
    dydw = dec2bcd(dydw);
...
void xSC02::armAlarm2(bool armed)
{
    uint8_t value;
    value = readRegister8(DS3231_REG_CONTROL);
...
bool xSC02::isAlarm2(bool clear)
{
    uint8_t alarm;
...
uint8_t xSC02::bcd2dec(uint8_t bcd)
{
    return ((bcd / 16) * 10) + (bcd % 16);
}

uint8_t xSC02::dec2bcd(uint8_t dec)
{
    return ((dec / 10) * 16) + (dec % 10);
}

char *xSC02::strDayOfWeek(uint8_t dayOfWeek)
{
    switch (dayOfWeek) {
        case 1:
            return "Monday";
...
char *xSC02::strMonth(uint8_t month)
{
    switch (month) {
        case 1:
            return "January";
...
char *xSC02::strAmPm(uint8_t hour, bool uppercase)
{
    if (hour < 12)
    {
        if (uppercase)
...
char *xSC02::strDaySufix(uint8_t day)
{
    if (day % 10 == 1)
    {
        return "st";
...
uint8_t xSC02::hour12(uint8_t hour24)
{
    if (hour24 == 0)
    {
        return 12;
...
long xSC02::time2long(uint16_t days, uint8_t hours, uint8_t minutes, uint8_t seconds)
{
    return ((days * 24L + hours) * 60 + minutes) * 60 + seconds;
}

uint16_t xSC02::dayInYear(uint16_t year, uint8_t month, uint8_t day)
{
    uint16_t fromDate;
    uint16_t toDate;
...
bool xSC02::isLeapYear(uint16_t year)
{
    return (year % 4 == 0);
}

uint8_t xSC02::daysInMonth(uint16_t year, uint8_t month)
{
    uint8_t days;
...
uint16_t xSC02::date2days(uint16_t year, uint8_t month, uint8_t day)
{
    year = year - 2000;
...
uint8_t xSC02::conv2d(const char* p)
{
    uint8_t v = 0;
...
uint8_t xSC02::dow(uint16_t y, uint8_t m, uint8_t d)
{
    uint8_t dow;
...
void xSC02::writeRegister8(uint8_t reg, uint8_t value)
{
    Wire.beginTransmission(DS3231_ADDRESS);
    #if ARDUINO >= 100
        Wire.write(reg);
...
uint8_t xSC02::readRegister8(uint8_t reg)
{
    uint8_t value;
    Wire.beginTransmission(DS3231_ADDRESS);
    #if ARDUINO >= 100
